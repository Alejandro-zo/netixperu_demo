<div id="netix_datos">
	<div class="netix_header">
		<div class="row netix_header_title">
			<div class="col-md-8 col-xs-12"> <h5>LISTA DE TIPO DE CAMBIOS</h5> </div>
		</div>
	    <div class="row">
				...
				<table class="table table-bordered table-condensed">
					...
					<tbody>
						<tr v-for="dato in datos">
							<td> <input type="radio" class="netix_radio" name="netix_seleccionar" v-on:click="netix_seleccionar(dato.codtipocambio)"> </td>
							<td>{{dato.fecha}}</td>
							<td>DOLAR</td>
							<td>{{dato.compra}}</td>
							<td>{{dato.venta}}</td>
