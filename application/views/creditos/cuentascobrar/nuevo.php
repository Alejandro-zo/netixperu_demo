<div id="netix_nuevocredito">
	<div class="netix_header">
		<div class="row netix_header_title">
			<div class="col-md-12 col-xs-12"> <h5>REGISTRO NUEVO CREDITO POR COBRAR</h5> </div>
		</div>
	</div> <br>
	        ...
	        <div class="x_panel">
			    ...
			    <div class="row form-group">
				    ...
				    <!-- <div class="col-md-4 col-xs-12">
				    	...
				    	<select class="form-control" name="tipocuota" v-model="campos.tipocuota" required v-on:change="netix_calcular()">
...
<script src="<?php echo base_url();?>netix/netix_creditos/nuevocobrar.js"> </script>
<script>
