	...
	<form id="formulario" class="form-horizontal" v-on:submit.prevent="netix_guardar()">
		<div class="col-md-7 col-xs-12">
			<div class="x_panel">
				...
				<div style="border-bottom:2px solid #f3f3f3;margin-bottom:10px;" align="center"> <b>CUOTAS A PAGAR</b> </div>
		...
		<div class="col-md-5 col-xs-12">
	        <div class="x_panel">
	        	<a class="btn btn-success btn-block"> <b style="font-size:25px;">
		    		TOTAL A PAGAR S/. {{campos.total}}</b> 
		    	</a> <br>
			    ...
			    <div class="row form-group">
			    	<div class="col-md-8 col-xs-12">
				    	...
				    	<select class="form-control" name="codconcepto" v-model="campos.codconcepto" required>
				    		<option value="17">PAGO DE CUOTAS</option>
				    	</select>
				    </div>
			    ...
			    <div class="row form-group" v-show="campos.codtipopago!=1">
				    ...
				    <div class="col-md-6 col-xs-12">
			        	...
			        	<input type="text" class="form-control" name="nrodocbanco" id="nrodocbanco" v-model.trim="campos.nrodocbanco" placeholder="Nro documento banco" autocomplete="off">
				    </div>
			    ...
			    <div class="row form-group" align="center">
					<div class="col-md-12" align="center"> <br>
						<button type="submit" class="btn btn-success btn-lg" v-bind:disabled="estado==1"> <b>GUARDAR PAGO</b> </button>
...
<script src="<?php echo base_url();?>netix/netix_creditos/pagar.js"> </script>
<script>
