		...
		<div class="row netix_header_title">
			<div class="col-md-8 col-xs-12"> 
				...
				<h5>
					...
					<b>CUENTAS POR PAGAR EN EL SISTEMA</b>
				</h5> 
			</div>
		</div>
	    <div class="row">
	    	<div class="col-md-8 netix_header_button">
		    	...
		    	<button type="button" class="btn btn-info" v-on:click="netix_cobranza()"> <i class="fa fa-money"></i> PAGAR </button>
			    <button type="button" class="btn btn-warning" v-on:click="netix_historial()"> <i class="fa fa-file-o"></i> HISTORIAL </button>
			    <button type="button" class="btn btn-success" v-on:click="netix_persona()"> <i class="fa fa-plus-circle"></i> NUEVO PROVEEDOR</button>
		    </div>
...
<script src="<?php echo base_url();?>netix/netix_creditos/cuentaspagar.js"> </script>