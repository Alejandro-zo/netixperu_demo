<div id="netix_form">
	<div style="padding:0px 10px;">
		<h6><b>NROSALIDA:</b> <?php echo $info[0]["seriecomprobante"]."-".$info[0]["nrocomprobante"];?> | <b>FECHA KARDEX:</b> <?php echo $info[0]["fechakardex"];?> </h6>
		...
		methods: {
			netix_guardar: function(){
				...
				this.$http.post(url+netix_controller+"/editar_guardar", this.campos).then(function(data){
					if (data.body==1) {
						netix_sistema.netix_alerta("EDITADO CORRECTAMENTE", "UNA SALIDA EDITADO EN EL SISTEMA","info");
					}else{
