<div id="netix_form">
	<div style="padding: 0px 20px;">
		<h6><b>NROINGRESO:</b> 000<?php echo $info[0]["codkardex"];?> | <b>FECHA:</b> <?php echo $info[0]["fechakardex"];?> </h6>
		...
		<h5 class="text-center"> <b>DETALLE DEL INGRESO</b> </h5>
		...
		<div class="alert alert-success" align="center" style="padding:5px;">
			<strong style="font-size:25px">TOTAL INGRESO: <?php echo $simbolo." ".number_format(round($info[0]["importe"],2) ,2);?></strong>
		</div>
	</div>
</div>