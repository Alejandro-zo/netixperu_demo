<div id="netix_datos">
	<div class="netix_header">
		<div class="row netix_header_title">
			<div class="col-md-8 col-xs-12"> <h5>LISTA DE LINEAS</h5> </div>
		</div>
	    <div class="row">
				...
				<table class="table table-bordered table-condensed">
						...
						<tr>
							...
							<?php 
								if ($_SESSION["netix_rubro"]==3) { ?>
									<th width="5px">COLOR</th>
									<th width="5px">FONDO</th>
								<?php }
							?>
					...
					<tbody>
						<tr v-for="dato in datos">
							<td> <input type="radio" class="netix_radio" name="netix_seleccionar" v-on:click="netix_seleccionar(dato.codlinea)"> </td>
							<?php 
								if ($_SESSION["netix_rubro"]==3) { ?>
									<td v-bind:style="{background: dato.color}"></td>
									<td v-bind:style="{background: dato.background}"></td>
								<?php }
							?>
