		    ...
		    <div class="row form-group">
	    		<div class="col-md-6">
				    <div class="col-md-6" style="padding-left: 0px;">
				    	...
				    	<input type="text" class="form-control datepicker" id="fechacomprobante" value="<?php echo date('Y-m-d');?>" autocomplete="off">
				    </div>
				    <div class="col-md-6" style="padding-left: 0px;">
				    ...
				    <div class="col-md-6" style="padding-left: 0px;padding-top: 10px">
				    	...
				    	<input type="text" class="form-control" v-model.trim="campos.seriecomprobante" maxlength="4" autocomplete="off">
				    </div>
				    <div class="col-md-4" style="padding-left: 0px;padding-top: 10px">
				    	<label class="text-center">NRO NOTA</label>
				    	<input type="text" class="form-control" v-model.trim="campos.nrocomprobante" maxlength="4" autocomplete="off">
				    </div>
			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					<tr v-for="(dato,index) in detalle">
						...
						<td>{{dato.unidad}}</td>
						<td>
							<input type="number" step="0.0001" class="netix-input number" v-model.number="dato.cantidad" v-on:keyup="netix_calcular(dato)" min="0.0001" required>
						</td>
						<td>
							<input type="number" step="0.0001" class="netix-input number" v-model.number="dato.precio" v-on:keyup="netix_calcular(dato)" min="0.0001" required>
						</td>
						<td>{{dato.igv}}</td>
						<td>{{dato.subtotal}}</td>
		    			<td>
		    				<button type="button" class="btn btn-danger btn-block btn-xs" style="margin-bottom:-1px;" v-on:click="netix_quitardetalle(index,dato)">
...
<script src="<?php echo base_url();?>netix/netix_notas/notacompra.js"> </script>
