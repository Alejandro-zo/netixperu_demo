<div id="netix_datos">
	<div class="netix_header">
		<div class="row netix_header_title">
			<div class="col-md-8 col-xs-12"> <h5>LISTA DE PERFILES</h5> </div>
		</div>
	    <div class="row">
	    	<div class="col-md-8 netix_header_button">
			    ...
			    <button type="button" class="btn btn-primary" v-on:click="netix_permisos()"> <i class="fa fa-key"></i> PERMISOS </button>
			...
			<div class="row">
				<div class="col-md-3 col-xs-12" v-for="dato in datos">
				    <div class="x_panel" align="center"> <br>
				    	<img src="<?php echo base_url();?>public/img/personas/default.png" class="img-circle img-thumbnail" style="height:80px;">
				      	<div class="x_content">
					        <h5 class="name" style="height:30px;">{{dato.descripcion}}</h5>
					        <div class="netix_radio_1"> 
					        	<input type="radio" class="netix_radio" name="netix_seleccionar" v-on:click="netix_seleccionar(dato.codperfil)"> 
					        </div>
				      	</div>
				    </div>
				</div>
