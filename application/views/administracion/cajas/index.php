<div id="netix_datos">
	<div class="netix_header">
		<div class="row netix_header_title">
			<div class="col-md-8 col-xs-12"> <h5>LISTA DE CAJAS</h5> </div>
		</div>
	    <div class="row">
			...
			<div class="row">
				<div class="col-md-3 col-xs-12" v-for="dato in datos">
				    <div class="x_panel" align="center">
				    	<img src="<?php echo base_url();?>public/img/caja.png" class="img-circle profile_img" style="height:100px;width:100px;margin-left:0px;">
				      	<div class="x_content">
					        <h4 class="name">{{dato.descripcion}}</h4>
					        <p>SUCURSAL: {{dato.sucursal}}</p>
					        <div class="netix_radio_1"> 
					        	<input type="radio" class="netix_radio" name="netix_seleccionar" v-on:click="netix_seleccionar(dato.codcaja)"> 
					        </div>
