...
class Ciqrcode
{
	...
	public function initialize($config = array()) {
		...
		$url = APPPATH."/third_party/netix_qrcode/";

		include $url."qrconst.php";
		include $url."qrtools.php";
		include $url."qrspec.php";
		include $url."qrimage.php";
		include $url."qrinput.php";
		include $url."qrbitstream.php";
		include $url."qrsplit.php";
		include $url."qrrscode.php";
		include $url."qrmask.php";
		include $url."qrencode.php";
	}
